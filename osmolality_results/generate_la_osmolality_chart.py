...
PRODUCTS = [
    {"product": "LA1", "spec_min": None, "spec_max": None, "lote_1": 575, "lote_2": None},
    {"product": "LA2", "spec_min": 280, "spec_max": 320, "lote_1": 308, "lote_2": 309},
    {"product": "LA3", "spec_min": 280, "spec_max": 320, "lote_1": 292, "lote_2": 292},
    {"product": "LA4", "spec_min": 220, "spec_max": 400, "lote_1": 280, "lote_2": 280},
    {"product": "LA5", "spec_min": None, "spec_max": None, "lote_1": 558, "lote_2": 565},
    {"product": "LA6", "spec_min": 240, "spec_max": 340, "lote_1": 308, "lote_2": 304},
    {"product": "LA7", "spec_min": 240, "spec_max": 340, "lote_1": 306, "lote_2": 308},
    {"product": "LA8", "spec_min": 250, "spec_max": 350, "lote_1": 281, "lote_2": 282},
    {"product": "LA9", "spec_min": 260, "spec_max": 320, "lote_1": 282, "lote_2": 292},
    {"product": "LA10", "spec_min": 160, "spec_max": 260, "lote_1": 214, "lote_2": 212},
    {"product": "LA11", "spec_min": 270, "spec_max": 330, "lote_1": 305, "lote_2": 297},
    {"product": "LA12", "spec_min": None, "spec_max": None, "lote_1": 276, "lote_2": 280},
]
...
def build_workbook(chart_png: Path, path: Path) -> None:
    ...
    for row_idx, p in enumerate(PRODUCTS, start=2):
        values = [
            ...
            row_idx - 1,
            p["lote_1"],  # None stays empty for Excel scatter
            p["lote_2"],
        ]
    ...
    ws.merge_cells(start_row=notes_row + 1, start_column=1, end_row=notes_row + 1, end_column=7)
    ws.merge_cells(start_row=notes_row + 2, start_column=1, end_row=notes_row + 2, end_column=7)
    ...
    data_bar = Reference(ws, min_col=8, min_row=1, max_col=9, max_row=last_data_row)
    ...
    xvalues = Reference(ws, min_col=10, min_row=2, max_row=last_data_row)
    y1_vals = Reference(ws, min_col=11, min_row=2, max_row=last_data_row)
    y2_vals = Reference(ws, min_col=12, min_row=2, max_row=last_data_row)
    ...
    ws_chart["A2"] = (
        "Eje X: Producto (LA1–LA12) | Eje Y: Osmolalidad (mOsm/kg), paso 25 | "
